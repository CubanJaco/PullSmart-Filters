...
class GitHubPRFilter {
  ...
  createFilterItem(label, query, checked) {
    ...
    const itemHtml = `
      <a class="SelectMenu-item custom-item" role="menuitemradio" aria-checked="${checked}" href="/${this.getRepoPath()}/pulls?q=${encodedQuery}" data-turbo-frame="repo-content-turbo-frame">
